...
// var container, scene, cameraPersp, renderer, controls, stats;
...
function init() 
{
	...
	// cameraPersp = new THREE.PerspectivecameraPersp( VIEW_ANGLE, ASPECT, NEAR, FAR);
	// scene.add(cameraPersp);
	// cameraPersp.position.set(0,150,400);
	...
	// EVENTS
	// THREEx.WindowResize(renderer, cameraPersp);
